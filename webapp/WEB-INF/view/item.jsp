    ...
    <div class="product_detail_page_container">
        <div class="product_detail_page_head_contents">
            ...
            <div class="product_detail_page_content_right">
                ...
                <form action="/test" method="GET">
                    ...
                    <button class="subscribeBtn" type="submit">구독하기</button>
        ...
        <div class="product_detail_page_body_contents">
            ...
            <div class="tab_purchase_detail content" id="tab2">
                <img class="tab_purchase_detail_img" src="/img/products/${product.instruction }"/>
            </div>
            <!-- -------------------------------리뷰------------------------- -->
                    ...
                    <li class="review_item">
                        <div class="review_wrap">
                            <div class="review_profile_box">
                                <img class="review_profile_img" src="/img/upload/profile/${review.memberProfileImg }" width="50" height="50"/>
                                <span class="review_user_nickname">${review.takerNickname}</span>
                                <span class="review_star_rating"><span></span></span>
                            </div>
                            <!--//review_profile_box-->
                            
                            <div class="reply_detail_box">
                                <div class="reply_detail">
                                <span class="reply">${review.review}</span>
                                    <p class="reply_regdate"><fmt:formatDate value="${review.regdate}" pattern="yyyy.MM.dd. HH:mm"/> </p>
                                </div>
                            </div>
                            <div class="rating">${review.star}</div>
